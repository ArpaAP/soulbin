...
export default function OnBoard() {
  return (
    <div className="relative flex min-h-screen w-full flex-col items-center justify-between overflow-hidden bg-white">
      {/* Main Content */}
      <div className="gap-g8 px-g8 flex flex-1 flex-col items-center justify-center pt-[120px] pb-[170px]">
        {/* Text Section */}
        <div className="gap-g3 flex flex-col items-center text-center">
          <h1 className="text-h3 leading-[2.25rem] font-semibold tracking-[-0.0406rem] text-black">
            꾸준히 쌓이는 나의 감정 기록
          </h1>
        ...
        <div className="relative w-full max-w-[285px]">
          <div className="aspect-[450/920] w-full overflow-hidden rounded-[40px]">
            {/* TODO: Replace with actual image */}
            <img
              src="http://localhost:3845/assets/0b9da5b53dabdc2cdbd6611ebc8ce6b19037bae0.png"
              alt="감정 기록 앱 미리보기"
      ...
      <div className="pointer-events-none absolute bottom-0 left-0 h-[340px] w-full bg-gradient-to-b from-transparent via-white/60 to-white" />

      {/* Bottom Button Section */}
      <div className="px-g8 pb-g8 relative z-10 flex w-full max-w-[402px] flex-col items-center gap-[10px]">
        {/* Page Indicator Dots */}
        <div className="flex items-center gap-[8px]">
          <div className="size-[6px] shrink-0 rounded-full bg-[#bebebe]" />
          <div className="size-[6px] shrink-0 rounded-full bg-[#bebebe]" />
          <div className="size-[6px] shrink-0 rounded-full bg-[#bebebe]" />
          <div className="size-[6px] shrink-0 rounded-full bg-black" />
        </div>
